...
// CONSTRUCTORS
HistoryStep::HistoryStep(const std::shared_ptr<Clause>& p_clause) :
m_clause(p_clause),
m_literal() {
}


HistoryStep::HistoryStep(const std::shared_ptr<Clause>& p_clause, Literal p_literal) :
m_clause(p_clause),
m_literal(p_literal) {
}
 ...
 */
std::shared_ptr<Clause> HistoryStep::clause() const {
	return m_clause;
}
